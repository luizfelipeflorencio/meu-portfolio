...
export default function Portfolio() {
  ...
  const projects = [
    {
      title: "SuiteFlow - SaaS Multi-tenant",
      description: "SaaS multi-tenant que unifica gestão operacional e automação de comunicação para clínicas, salões e barbearias. Como desenvolvedor Front-end, criei as telas, implementei regras de negócio no cliente e desenvolvi lógicas complexas para otimizar o fluxo dos usuários. Integrações com Stripe, WhatsApp (Evolution API), agendamento, prontuário, faturamento, white-label e RBAC.",
      technologies: ["Next.js 15", "React 19", "TailwindCSS", "ShadCN", "Zustand", "TanStack Query"],
      github: null,
      demo: "https://use.suiteflow.com.br/",
      image: "/odonto.png",
    },
    {
      title: "SuiteFlow - Landing Page Comercial",
      description: "Landing page comercial do SuiteFlow, SaaS brasileiro de agendamento e gestão para salões, barbearias, clínicas e estéticas. Site público de vendas com seções de funcionalidades, planos (Grátis, Pro, Enterprise), tabela comparativa, FAQ interativa com structured data e segmentação por nicho. SEO completo com Schema.org, Open Graph, sitemap XML e robots.txt. Integração com Chatwoot e Microsoft Clarity. Responsável pelo desenvolvimento completo do front-end e estratégia de SEO.",
      technologies: ["Next.js 16", "React 19", "TypeScript", "TailwindCSS", "Framer Motion"],
      github: null,
      demo: "https://suiteflow.com.br",
      image: "/land.png",
    },
    {
